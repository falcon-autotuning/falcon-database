...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--enable-shared' '--disable-static' '--prefix=/home/tylerk/falcon-dev/falcon-database/.falcon-deps/vcpkg_installed/x64-linux-dynamic' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=clang' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/tylerk/falcon-dev/falcon-database/.falcon-deps/vcpkg_installed/x64-linux-dynamic/lib -L/home/tylerk/falcon-dev/falcon-database/.falcon-deps/vcpkg_installed/x64-linux-dynamic/lib/manual-link' 'CPPFLAGS=-DNDEBUG' 'CXX=clang++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/tylerk/.local/share/vcpkg/packages/libpq_x64-linux-dynamic/lib/pkgconfig:/home/tylerk/.local/share/vcpkg/packages/libpq_x64-linux-dynamic/share/pkgconfig:/home/tylerk/falcon-dev/falcon-database/.falcon-deps/vcpkg_installed/x64-linux-dynamic/lib/pkgconfig:/home/tylerk/falcon-dev/falcon-database/.falcon-deps/vcpkg_installed/x64-linux-dynamic/share/pkgconfig:/opt/falcon/lib/pkgconfig:/opt/falcon/lib/pkgconfig:'"
